function CPaytableLandscape(oParentContainer){
    CPaytablePanelBase.call(this, oParentContainer);
    
    this._init();
    
    var oPosNext = {x:CANVAS_WIDTH - 230,y:CANVAS_HEIGHT/2};
    var oPosPrev = {x:230,y:CANVAS_HEIGHT/2};
...
CPaytableLandscape.prototype._init = function(){
    ...
    var oSpriteBg = s_oSpriteLibrary.getSprite('paytable1_landscape');
    ...
    var oSpriteBg = s_oSpriteLibrary.getSprite('paytable2_landscape');
    var oBg = createBitmap(oSpriteBg);
    oBg.x = CANVAS_WIDTH/2;
    oBg.y = CANVAS_HEIGHT/2;
    oBg.regX = oSpriteBg.width/2;
    ...
    var oSpriteBg = s_oSpriteLibrary.getSprite('paytable3_landscape');
    var oBg = createBitmap(oSpriteBg);
    oBg.x = CANVAS_WIDTH/2;
    oBg.y = CANVAS_HEIGHT/2;
    oBg.regX = oSpriteBg.width/2;
    ...
    var oSpriteBg = s_oSpriteLibrary.getSprite('paytable4_landscape');
    var oBg = createBitmap(oSpriteBg);
    oBg.x = CANVAS_WIDTH/2;
    oBg.y = CANVAS_HEIGHT/2;
    oBg.regX = oSpriteBg.width/2;
    ...
    var oText = new CTLText(oContainerPage, 
                CANVAS_WIDTH/2-280, 920, 560, 280, 
...
CPaytableLandscape.prototype._createPayouts = function(oContainerPage){
    this._aNumSymbolComboText = new Array();
    this._aWinComboText = new Array();

    var aPos = [{x:1164,y:1128},{x:800,y:1128},{x:1340,y:944},{x:990,y:944},{x:636,y:944},{x:1164,y:756},{x:804,y:756}];
    var iCurPos = 0;
