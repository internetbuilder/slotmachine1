function CSpriteSheetTextButton(iXPos,iYPos,oSprite,szText,szFont,szColor,iFontSize,oContainer){
    ...
    this.buttonRelease = function(){
        ...
        if(_aCbCompleted[ON_MOUSE_UP]){
            _aCbCompleted[ON_MOUSE_UP].call(_aCbOwner[ON_MOUSE_UP],_oText.getString());
        }
    };
    ...
    this.buttonDown = function(){
       ...
       if(_aCbCompleted[ON_MOUSE_DOWN]){
           _aCbCompleted[ON_MOUSE_DOWN].call(_aCbOwner[ON_MOUSE_DOWN],_oText.getString());
       }
    };
